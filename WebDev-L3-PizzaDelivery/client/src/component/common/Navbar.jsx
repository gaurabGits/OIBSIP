...
function Navbar() {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-lg shadow-red-900/30 to-[#e63946]">
      <div className="w-full border-t bg-gradient-to-r from-[#c1121f] to-[#e63946] px-3 sm:px-5 md:px-10">
        <nav className="mx-auto flex min-h-[64px] max-w-7xl items-center gap-3 px-2 py-2.5 sm:min-h-[72px] sm:gap-6 sm:px-5">
          <Link to="/" aria-label="SliceHouse home" className="shrink-0">
            <SystemLogo />
          </Link>
            ...
            <div className="flex flex-col gap-1 px-4 pb-5 pt-3 sm:px-6">
              ...
              {isVerified ? (
                <>
                  ...
                  <Link className="mt-2 flex items-center justify-center gap-2 rounded-full bg-amber-400 px-5 py-3 font-extrabold text-stone-900 shadow-md transition hover:bg-amber-500" to="/menu">
